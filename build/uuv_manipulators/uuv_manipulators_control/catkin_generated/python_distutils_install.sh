...
echo_and_run cd "/root/uuv_ws/src/uuv_manipulators/uuv_manipulators_control"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/root/uuv_ws/src/uuv_manipulators/uuv_manipulators_control/setup.py" \
     \
    build --build-base "/root/uuv_ws/build/uuv_manipulators/uuv_manipulators_control" \
    install \
    --root="${DESTDIR-/}" \
