...
echo_and_run cd "/root/uuv_ws/src/uuv_simulator/uuv_assistants"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/root/uuv_ws/src/uuv_simulator/uuv_assistants/setup.py" \
     \
    build --build-base "/root/uuv_ws/build/uuv_simulator/uuv_assistants" \
    install \
    --root="${DESTDIR-/}" \
