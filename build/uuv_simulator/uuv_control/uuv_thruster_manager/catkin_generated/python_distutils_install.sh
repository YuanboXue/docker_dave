...
echo_and_run cd "/root/uuv_ws/src/uuv_simulator/uuv_control/uuv_thruster_manager"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/root/uuv_ws/src/uuv_simulator/uuv_control/uuv_thruster_manager/setup.py" \
     \
    build --build-base "/root/uuv_ws/build/uuv_simulator/uuv_control/uuv_thruster_manager" \
    install \
    --root="${DESTDIR-/}" \
